...
import { sampleRecords, sampleAdjustments } from '@/lib/sample-data';
import { 
  Card, 
  CardContent, 
  CardDescription, 
...
import { Loader2, Database, Activity, Settings, ExternalLink, Check, X, ArrowLeft } from 'lucide-react';
...
export default function BlockchainPage() {
  ...
  // Sample blockchain record data imported from lib/sample-data.ts
  ...
  const { 
    ...
    enabled: true,
    select: (data) => data?.length ? data : sampleRecords
  });
  ...
  // Sample corresponding adjustment data imported from lib/sample-data.ts
